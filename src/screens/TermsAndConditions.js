    ...
    <View
      ...
      <View
        ...
        <View id="warnContent1" style={{alignItems: 'center'}}>
          <Text style={{padding: 3}}>-No age restriction.</Text>
          <Text style={{padding: 3}}>-Any one can play.</Text>
          ...
          <View
            ...
            <Text
              ...
              onPress={() =>
                Linking.openURL(
                  'https://wonderful-ground-0d36c2200.2.azurestaticapps.net/freetalk-eula-en.html',
                )
              }>
              Terms of Services
            </Text>
            ...
            <Text
              ...
              onPress={() =>
                Linking.openURL(
                  'https://wonderful-ground-0d36c2200.2.azurestaticapps.net/freetalk-privacy-en.html',
                )
              }>
              Privacy Policy.
            </Text>
