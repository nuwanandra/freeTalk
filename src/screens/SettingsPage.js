    ...
    <SafeAreaView
      ...
      <View id="Level">
        ...
        <View
          ...
          />
          <Text onPress={() => setLevel('1')} style={{fontSize: 24}}>
            Simple
          </Text>
        </View>
        ...
        <View
          ...
          />
          <Text onPress={() => setLevel('2')} style={{fontSize: 24}}>
            Avarage
          </Text>
        </View>
        ...
        <View
          ...
          />
          <Text onPress={() => setLevel('3')} style={{fontSize: 24}}>
            Hard
          </Text>
        </View>
      </View>
      ...
      <View id="operationCount">
        ...
        <View style={{width: '60%', marginLeft: 30, marginTop: 10}}>
          <SelectList
            ...
            inputStyles={{fontSize: 20, height: 22}}
      ...
      {sample === '' ? null : (
        <Text style={{fontSize: 50, fontWeight: 'bold', marginLeft: 10}}>
          {sample
            .replace(/\s+/g, '')
            .replace(/\*/g, ' x ')
            .replace(/\//g, ' / ')
