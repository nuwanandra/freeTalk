  ...
  return (
    <SafeAreaView
      ...
      <View style={{flexDirection: 'row', marginTop: 5, alignItems: 'center'}}>
        <Text style={{fontSize: 26}}>Welcome {userName}</Text>
        <Image
          source={
            gender === 'Male'
      ...
      <View style={{marginTop: 30, alignItems: 'center'}}>
        <Text style={{fontSize: 24, fontWeight: 'bold'}}>Why Simple Math?</Text>
        <Text style={{fontSize: 24}}> Easy and simple</Text>
        <Text style={{fontSize: 24}}> Improve your memory</Text>
        <Text style={{fontSize: 24}}> Keep active your brain functions</Text>
        <Text style={{fontSize: 24}}> Use 10 minutes a day...</Text>
      </View>
    </SafeAreaView>
  );
}
